...
This function returns amount of `buy_gem` tokens if `pay_gem` tokens are spent. It can be used to check the current state of the orderbook.
...
This function returns amount of `pay_gem` tokens that need to be spent to buy specified amount of `buy_gem`. It can be used to check the current state of the orderbook.
