...
**Buy** method that will be describe in this section could be used for taking orders but it **SHOULD** be used with caution. 
...
It **SHOULD BE* used with **CAUTIOUS** only by people who knows what they are doing.
