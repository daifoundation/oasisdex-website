...
In case of rounding errors, this method will try to match orders that are "close enough" expected price.
...
Offer method with six arguments is the alternative, not recommended way of placing orders.
