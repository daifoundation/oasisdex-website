...
// before placing an offer the user should set allowance

#### **Offer**

There are couple of implementation of the _offer_ method. Each implementation is use for different cases.

First of the implementations can be found in the [simple market](https://github.com/daifoundation/maker-otc/blob/master/src/simple_market.sol#L240) smart contract.
...
Second of the implementations can be found in the [matching_market](https://github.com/daifoundation/maker-otc/blob/master/src/matching_market.sol#L129) smart contract.
...
Third of the implementations can be found in the [matching_market](https://github.com/daifoundation/maker-otc/blob/master/src/matching_market.sol#L115) smart contract.
This method leverages the power of the matching engine and also takes into account some concerns. This methods is a wrapper of the second implementation ( mentioned above ).
...
This is the **RECOMMENDED** way of creating new offers.
